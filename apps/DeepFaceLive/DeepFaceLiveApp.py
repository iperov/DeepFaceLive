...
class QDFLAppWindow(qtx.QXWindow):
    ...
    def __init__(self, userdata_path, settings_dirpath):
        ...
        menu_language_action_japanese = menu_language.addAction('日本語')
        menu_language_action_japanese.triggered.connect(lambda: (qtx.QXMainApplication.inst.set_language('ja-JP'), qtx.QXMainApplication.inst.reinitialize()) )

        menu_language_action_german = menu_language.addAction('Deutsch')
        menu_language_action_german.triggered.connect(lambda: (qtx.QXMainApplication.inst.set_language('de-DE'), qtx.QXMainApplication.inst.reinitialize()) )
